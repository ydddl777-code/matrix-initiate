...
export const SanctuaryInterior = ({ onExit }: SanctuaryInteriorProps) => {
  ...
  // Continue Warning in the Dark at low volume
  useEffect(() => {
    if (musicRef.current) {
    ...
    <div className="fixed inset-0 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 z-[1] pointer-events-none">
        ...
        <div
          ...
          style={{
            background: `
              radial-gradient(ellipse 50% 40% at 50% 0%, hsl(45 90% 95% / 0.08) 0%, transparent 100%),
              radial-gradient(circle at 50% 50%, hsl(45 80% 50% / 0.04) 0%, transparent 50%)
            `,
          }}
        />
        ...
        {["top-6 left-6", "top-6 right-6", "bottom-6 left-6", "bottom-6 right-6"].map((pos, i) => (
          <div
            ...
            style={{
              background: "hsl(45 80% 50% / 0.3)",
              boxShadow: "0 0 12px hsl(45 80% 50% / 0.4)",
            }}
          />
        ))}
        ...
        <div
          ...
          style={{
            background: `
              linear-gradient(to top, hsl(0 0% 0% / 0.9) 0%, transparent 100%)
            `,
          }}
        />
        <div
      ...
      <div className="absolute left-0 top-0 bottom-0 w-[12%] md:w-[15%] z-[2] overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-12 left-2 z-10">
          <p
            ...
            style={{ color: "hsl(45 80% 50%)", opacity: 0.6 }}
          >
            GAD
          </p>
        </div>
      ...
      <div className="fixed top-4 left-4 z-50">
        <button
          ...
          style={{
            borderColor: "hsl(45 80% 50% / 0.3)",
            color: "hsl(45 80% 50% / 0.7)",
          }}
        >
      ...
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50">
        <div className="px-4 py-1.5 bg-black/60 backdrop-blur-sm rounded-full border"
          style={{ borderColor: "hsl(45 80% 50% / 0.2)" }}
        >
          <p
            className="font-display text-xs md:text-sm tracking-[0.3em]"
